...
namespace ExiledKitsPlugin
{
    public class Config : IConfig
    {
        ...
        {
            new KitEntry()
                { Name = "itemdemo", UsePermission = false, Ammo = null, Effects = null, Enabled = true, ClearInventory = false, WhitelistedRoles = null, Items = new List<ItemType>() { ItemType.Coin, ItemType.Adrenaline }, CooldownInSeconds = 180},
            new KitEntry()
                { Name = "ammodemo", UsePermission = true, Ammo = new Dictionary<AmmoType, ushort>() { { AmmoType.Nato9, 30}, { AmmoType.Nato556, 5}}, Effects = null, Enabled = true, ClearInventory = true, WhitelistedRoles = null,Items = new List<ItemType>() { ItemType.GunCOM15, ItemType.Flashlight }, CooldownInSeconds = 60f},
            new KitEntry()
                { Name = "effectdemo", UsePermission = false, Ammo = new Dictionary<AmmoType, ushort>() { { AmmoType.Nato9, 60}, { AmmoType.Nato556, 15}}, Effects = new List<Effect>(){new Effect(EffectType.Scp207, 120f, 2), new Effect(EffectType.MovementBoost,120f,50)}, Enabled = true, ClearInventory = false, DropExcess = true, WhitelistedRoles = null, Items = new List<ItemType>() { ItemType.GunFSP9, ItemType.Medkit }, CooldownInSeconds = -1f},
            new KitEntry()
                {Name = "ChaoticRevolt", UsePermission = true, ClearInventory = true,InitialCooldown = 20, CooldownInSeconds = 30, Enabled = true, Items = new List<ItemType>(){ItemType.Adrenaline, ItemType.KeycardMTFOperative, ItemType.GunA7, ItemType.ArmorHeavy, ItemType.Medkit, ItemType.Medkit}, Ammo = new Dictionary<AmmoType, ushort>(){{AmmoType.Nato762, 120},
            ...
            new KitEntry()
            {
                Name = "roledemo", UsePermission = true, Ammo = null, Effects = null, Enabled = true, ClearInventory = false, WhitelistedRoles = null, BlacklistedRoles = new List<RoleTypeId>() { RoleTypeId.ClassD}, Items = new List<ItemType>() { ItemType.Adrenaline, ItemType.Medkit, ItemType.Lantern },
